...
class Dimensions {
 ...
 static double pageViewContainer = screenHeight/3.53 ;
 ...
 static double height15 = screenHeight/ 52.066;
 ...
 static double popular_img_size = screenHeight/ 2.5;

 //bottom height
 static double bottomHeight= screenHeight/6.5;
}